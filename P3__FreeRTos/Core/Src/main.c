...
/* Definitions for deltaAceQueue */
osMessageQueueId_t deltaAceQueueHandle;
const osMessageQueueAttr_t deltaAceQueue_attributes = {
  .name = "deltaAceQueue"
};
...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
fsm_move_t f_move_acc;
fsm_move_t f_move_mag;
/* USER CODE END 0 */
